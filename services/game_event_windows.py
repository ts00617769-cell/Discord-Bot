...
REALM_TRANSFER_WINDOWS: list[tuple[str, str, str]] = [
    ...
    # 週期約為每月第一個週三 12:00～該週日 23:59；開服後請以官網公告校正
    ("2026-08-05 12:00:00", "2026-08-09 23:59:59", "第28次領域轉移"),
]
...
CLASS_CHANGE_WINDOWS: list[tuple[str, str, str]] = [
    ...
    # 週期約 2～4 週；開賣後請以官網公告校正
    ("2026-08-06 05:00:00", "2026-08-20 05:00:00", "職業變更商品（預估）"),
]
